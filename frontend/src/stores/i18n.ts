...
const translations: Record<Language, Translations> = {
  en: {
    ...
    classes: {
      ...
      classNamePlaceholder: 'e.g., 1.A, 2.B',
    ...
    teachers: {
      ...
      allGradeLevelsOrSelect: 'All Grade Levels (or select specific grade level)',
  ...
  cs: {
    ...
    teachers: {
      ...
      allGradeLevelsOrSelect: 'Všechny ročníky (nebo vybrat konkrétní ročník)',
      allGradeLevels: 'Všechny ročníky',
      gradeLevel: 'Ročník',
